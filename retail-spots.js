...
window.TRIP_SPOTS.push(
  ...
  r("muji-aeon-takamatsu", "無印良品 イオンモール高松", "shopping", "購物", "D3", "7/20 晚間備案", "AEON Mall 高松", 34.3523, 134.0056, "backup", "無印良品 イオンモール高松", "若在 AEON Mall 高松逛 mont-bell / Snow Peak，可順手確認無印良品；以 Google Maps 現況為準。", ["無印良品", "MUJI", "AEON", "イオンモール", "AEON Mall 高松", "大型商場"]),
  r("aeon-mall-ayagawa", "イオンモール綾川 / AEON Mall 綾川", "shopping", "購物", "D1/D4/D6", "機場・琴平線備案", "綾川 / 高松機場西側", 34.2496, 133.9320, "main", "イオンモール綾川", "高松機場、琴平、國道 32 號周邊最實用的大型商場之一，可一次處理 AEON 超市、UNIQLO、無印、餐廳與食品補給。", ["AEON", "イオンモール", "AEON Mall", "大型商場", "超市", "食品補給", "UNIQLO", "MUJI", "餐廳", "機場線", "琴平線"]),
  r("uniqlo-aeon-ayagawa", "UNIQLO イオンモール綾川店", "shopping", "購物", "D1/D4/D6", "機場・琴平線備案", "綾川 / 高松機場西側", 34.2496, 133.9320, "backup", "ユニクロ イオンモール綾川店", "高松機場、琴平、國道 32 號周邊可用的大型商場 UNIQLO 候選。", ["UNIQLO", "AEON", "イオンモール綾川", "機場線", "商場"]),
  r("muji-aeon-ayagawa", "無印良品 イオンモール綾川", "shopping", "購物", "D1/D4/D6", "機場・琴平線備案", "綾川 / 高松機場西側", 34.2496, 133.9320, "backup", "無印良品 イオンモール綾川", "高松機場與琴平線備案，適合時間多時把 UNIQLO、無印、餐飲與超市一次處理。", ["無印良品", "MUJI", "AEON", "イオンモール綾川", "機場線"]),
...
window.TRIP_SPOT_META = {
  ...(window.TRIP_SPOT_META || {}),
  updatedAt: "2026-07-07 14:55",
  version: "nearby spots v7 retail AEON brand search"
};

const brandSearchPlaceholder = "搜尋：AEON、イオン、UNIQLO、無印良品、MUJI、藥妝、DAISO、mont-bell、Snow Peak...";
const brandSearchInput = typeof document !== "undefined" ? document.getElementById("searchInput") : null;
if (brandSearchInput) brandSearchInput.placeholder = brandSearchPlaceholder;

if (typeof document !== "undefined" && document.currentScript) {
  document.write('<script src="./drugstore-spots.js?v=202607071435"><\/script><script src="./lilay-spots.js?v=202607180009"><\/script>');
}
